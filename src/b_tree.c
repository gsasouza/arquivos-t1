...
/**
 * init index file
 * @param file - index file pointer
 * @return header from new file
 */
...
/**
 * driver for btree in order pront
 * @param file - index file
 * @param node - current node
 */
